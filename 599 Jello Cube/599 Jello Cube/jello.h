...
// Rest Lengths of all kinds of springs
extern double SRLength;					//	Structural rest length
extern double SHSideRLength;				//	Shear face side rest length
extern double SHDiagonalRLength;			//	Shear diagonal rest length
extern double BRLength;					//	Bend rest length
...
//------
extern bool _highshineLevel; //Whether the shininess parameter is high
extern bool _lowspecLevel; //Whether the specularity parameter is high
extern bool _emissLevel; //Whether the emission parameter is turned on
//------
...
extern int shear, bend, structural, pause, viewingMode, saveScreenToFile, ActivateFF, sphereExists;
